...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-19 20:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/abe7c44d-da3a-435c-aaca-f5d690512d3f.git
$ cd abe7c44d-da3a-435c-aaca-f5d690512d3f
```
